...
export default function WelcomePage() {
  ...
  //(scrollY, breakpoints, opacity value)
  //breakpoints will be how much pixels the user scrolled and according to that how much opacity we need in this case will be third arguement
